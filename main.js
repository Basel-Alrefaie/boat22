...
physic.update();
    ...
    */
      ...
      // boatModel.position.set(boatModel.position.x, boatModel.position.y, boatModel.position.z);
      models[0].position.x= boatModel.position.x;
      models[0].position.y= boatModel.position.y;
      models[0].position.z= boatModel.position.z;
   
    //  model.position.set(boatModel.position.x, boatModel.position.y, boatModel.position.z);
    //  models[0].position.x= model.position.x;
    //  models[0].position.y= model.position.y;
    //  models[0].position.z= model.position.z;
